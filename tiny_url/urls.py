...
from shorteners.views import VisitUrlView


urlpatterns = [
    path('', RedirectView.as_view(url='/shorteners/list')),
    path('auth/admin/', admin.site.urls),
    path('auth/signup/', user_views.signup, name='signup'),
    path('shorteners/', include('shorteners.urls')),
    ...
    path('<str:code>', VisitUrlView.as_view(), name='visit')
